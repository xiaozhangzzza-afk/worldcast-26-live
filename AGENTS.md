...
- 当前 V5.0.1 展示层为轻量多页面：`index.html`、`predictions.html`、`schedule.html`、`teams.html`、`about.html`，样式在 `assets/css/style.css`，统一数据服务在 `assets/js/data-service.js`，世界杯与五大联赛标准化逻辑分别在 `assets/js/data-normalizer.js`、`assets/js/league-normalizer.js`。
